...
class GlobleConstant {
  static String save = "SAVE";
  static String View = "VIEW EXCEL ";

//  Guest EntryList
  static var GFamilyName = "Family Name";
  static var GName = "Guest Name";
  static var InvitationType = "Invention Type";
  static var DriverName = "Driver Name";
  static var VehicleNumber = "Vehicle Number";
  static var GDeriverName = "Driver Name";
  static var Gmobilenumber = "Mobile Number";

  //validations
  static var VGFamilyName = "Please enter family name";
  static var VGName = "Please enter guest name";
  static var VGDerivername = "Please enter driver name";
  static var VGvehicalNumber = "Please enter vehicle number";
  static var VGmobile = "Please enter valid mobile number";
  // Excel Data
  static var Gmobnumber = "Mob number";
  static var AppType="mobile";
  static var gate1entry="Gate 1 ENTRY";
  static var isGuestWithDerver="Is Guest With Driver ?";
  static var isGuestOnly="Is Guest Only?";
  static var isDeriverOnly="Is Driver Only?";
  ...
  static String eventStartDate="";

  static String eventendDate="";

  static String reportField="";
